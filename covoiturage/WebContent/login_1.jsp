...
<%
	String registerFailed = (String)session.getAttribute("registerFailed");
%>
				...
				<div class="wrap-body-inner">
					...
					<section class="block-login m-t-lg-30 m-t-xs-0 m-b-lg-50">
						<div>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6 m-b-sm-30 m-b-xs-30">
									<!-- Create an account -->
									<div class="p-lg-30 p-xs-15 bg-gray-f5 bg1-gray-15">
										<h3 class="p-t-lg-0">créer un nouveau compte</h3>
										<%
										if(registerFailed != null){
										%>
										
											<p class="m-b-lg-15 text-danger"><%=registerFailed%></p>
										
										<%
											session.setAttribute("registerFailed", null);
											}
										%>
										<p>s'il vous plaît entrez vos données personnelles!</p>
										<form action="Register" method="post">
											<div class="form-group">
												<input type="text" name="nom" class="form-control form-item" placeholder="nom">
											</div>
											<div class="form-group">
												<input type="text" name="prenom" class="form-control form-item" placeholder="prenom">
											</div>
											<div class="form-group">
											...
											<div class="form-group">
											<input type="radio" name="type" value="conducteur" checked> Conducteur &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="type" value="passager"> Passager											
											</div>
								...
								<div class="col-md-6 col-lg-6">
									<!-- Login -->
									<div class="p-lg-30 p-xs-15 bg-gray-f5 bg1-gray-15">
										<h3 class="p-t-lg-0">Déjà inscrit?</h3>
										<p>Saisir votre email et mot de pass</p>
